...
(() => {
  ...
  const text = {
    en: {
      ...
      dnsDescription: "Create DNS profiles using a known provider or your own DNS settings.",
      ...
      importApple: "Import .mobileconfig",
      importAndroid: "Import .sswan",
      importWindows: "Import .ps1",
      importConfigurationHint: "Load an existing file to edit its settings.",
    ...
    ru: {
      ...
      comingSoon: "Скоро",
      dnsDescription: "Создавайте DNS-профили, выбрав известного провайдера или указав собственные настройки DNS.",
      ...
      importApple: "Импортировать .mobileconfig",
      importAndroid: "Импортировать .sswan",
      importWindows: "Импортировать .ps1",
      importConfigurationHint: "Загрузите существующий файл, чтобы изменить его настройки.",
    ...
    lv: {
      ...
      comingSoon: "Drīzumā",
      dnsDescription: "Izveidojiet DNS profilus, izvēloties zināmu pakalpojuma sniedzēju vai norādot savus DNS iestatījumus.",
      ...
      importApple: "Importēt .mobileconfig",
      importAndroid: "Importēt .sswan",
      importWindows: "Importēt .ps1",
      importConfigurationHint: "Ielādējiet esošu failu, lai mainītu tā iestatījumus.",
      requiredFieldsNote: "Obligātie lauki",
